...
-- -----------------------------------------------------
-- Table `delivery_lanches`.`endereco_entrega`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `delivery_lanches`.`endereco_entrega` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `delivery_lanches`.`pedidos` (
  ...
  CONSTRAINT `pedidos_ibfk_2`
    ...
    REFERENCES `delivery_lanches`.`entregadores` (`id`),
  CONSTRAINT `pedidos_ibfk_3`
    FOREIGN KEY (`endereco_id`)
    REFERENCES `delivery_lanches`.`endereco_entrega` (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `delivery_lanches`.`historico_pedidos` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `pedido_id` INT(11) NOT NULL,
  `status` ENUM('pendente', 'aceito', 'em_entrega', 'entregue', 'cancelado') NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `delivery_lanches`.`lojas` (
  ...
  `data_criacao` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `status` ENUM('aberto', 'fechado') NULL DEFAULT 'fechado',
  `horarios` TEXT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `delivery_lanches`.`pagamentos` (
  ...
  `comprovante_url` VARCHAR(255) NULL DEFAULT NULL,
  `data` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  PRIMARY KEY (`id`),
  INDEX `pedido_id` (`pedido_id` ASC) VISIBLE,
  INDEX `forma_pagamento_id` (`forma_pagamento_id` ASC) VISIBLE,
